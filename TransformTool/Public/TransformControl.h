...
public:
    ...
    void SetIsOrthogonal( bool bIsOrthogonal );

    class ControlAxes* GetCurrentAxes();

    class ControlAxes* GetMoveAxes();

    class ControlAxes* GetRotateAxes();

    class ControlAxes* GetScaleAxes();
...
private:
    ...
    class ControlAxes* CurrentAxes;

    class ControlAxes* MoveAxes;

    class ControlAxes* RotateAxes;

    class ControlAxes* ScaleAxes;
    ...
    void DefaultTransformControlUpdate();

    void OrthographicTransformControlUpdate();
